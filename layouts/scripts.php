...
?>
<!-- Deneged -->
<!-- <script src="../Js/Dangerback.js"></script> -->
...
<script src="../styles/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>

<script src="../Js/EstadisticsMtto.js"></script>
