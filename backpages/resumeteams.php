                ...
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">                  
                            ...
                            <a href="../report/ResumeTeams?teams=<?php echo $tk_teams; ?>" target="_blank" class="btn btn-danger">Ver formato</a>
                        </div>            
                    </div>   
                            ...
                            <div class="row">
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;"  class="input-group-text">Fecha</span>
                                    </div>
                                    <input style="background-color: #FCF3CF;" value="<?php echo $date; ?>" type="text" class="form-control" disabled>
                                </div>

                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;"  class="input-group-text">Nombre específico</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Tipo de equipo</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Costos total de mantenimientos</span>
                                    </div>
                                    <input style="background-color: #EAFAF1;" type="text" value="$<?php echo number_format($total_m); ?>" class="form-control" disabled>
                                </div>

                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Modelo</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Serie</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Referencia</span>
                                    </div>
                                    <input style="background-color: #FCF3CF;" type="text" class="form-control" value="<?php echo $reference; ?>" disabled>
                                </div>

                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Capacidad</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Marca</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-6">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Placa</span>
                                    </div>
                                ...
                                <div class="input-group mb-1 col-sm-12">
                                    <div class="input-group-prepend">
                                        <span style="background-color: #F8F9F9;" class="input-group-text">Caracteristicas</span>
                                    </div>
                                    <input type="text" class="form-control" name="description" value="<?php echo $description;?>">
                                    <div class="input-group-append">
                                        <div class="input-group-text"><i class="fas fa-exclamation-circle" title="NO REGISTRAR SIMBOLOS"> </i></div>
                                    </div>
                                </div>
                                ...
                                <table class='table table-bordered col-sm-12'>
                                  <thead>
                                      <tr style='background-color: #F8F9F9;'>
                                          ...
                                          <th colspan='2' style='text-align: center;'>FRECUENCIA DE INSPECCIÓN Y MANTENIMIENTO</th>
                                      </tr>
                                        ...
                                        <tbody>
                                            <td colspan="2">
                                                <div class="filtr-item col-sm-12" data-category="1" data-sort="white sample">
                                                    <a href="<?php echo $url_image_uno; ?>" data-toggle="lightbox" data-title="Fotografia No. 1">
                                                        <img src="<?php echo $url_image_uno; ?>" style="height: 200px; width: 400px;" alt="FOTOGRAFIA NO REGISTRADA"/>
                                                    </a>
                                                </div>
                                            </td>

                                            <td colspan="2">
                                                <div class="filtr-item col-sm-12" data-category="2" data-sort="white sample">
                                                    <a href="<?php echo $url_image_dos; ?>" data-toggle="lightbox" data-title="Fotografia No. 2">
                                                        <img src="<?php echo $url_image_dos; ?>" style="height: 200px; width: 400px;" alt="FOTOGRAFIA NO REGISTRADA"/>
                                                    </a>
                                                </div>
                                            </td>
            ...
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
              <div class="modal-body">  
                ...
                <div class="callout callout-info">
                  ...
                  <p>                                                                             
                      1) Escribimos en la casilla Mantenimiento a realizar, la descripción de la actividad a realizar.<br>            
              ...
              <div class="modal-body">  
                  ...
                  <div class="callout callout-info">
                    ...
                    <p>                                                                             
                        ...
                        2) En la casilla Fecha proxima ejecución, ingresamos la fecha del proximo mantenimiento a realizar.<br>
