...
<page backtop="25mm" backttom="15mm" backleft="0m" backright="0mm">
    ...
    <page_header>
            <table style="border: 1px solid black;">
                <tr>
                    ...
                    <td rowspan="3" style="border: 1px solid black; font-weight: bold; font-size: 18px; text-align:center; width: 380px;">ENTRADA DE ACTIVOS AL ALMACÉN</td>
                    <td style="border: 1px solid black; width: 100px; font-size: 11px;">Código: F-263</td>
                </tr>
                <tr>
    ...
    <table>
        <tr style="font-size: 12px; text-align: center;">
            ...
            <th style="border: 1px solid black; width:130px;">FECHA DE INGRESO</th>
        ...
        <?php echo $mtto->getDatosF263($id_warehouse); ?>
