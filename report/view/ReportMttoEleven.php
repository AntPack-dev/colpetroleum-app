...
<page backtop="25mm" backbottom="15mm" backleft="0mm" backright="0mm">
  ...
  <tr style="background-color: #273746; text-align:center; ">
    <th colspan="8" style="color: white; border-radius: 2px; border: 0.5px solid black; height: 20px;">GENERAL | FECHA DESDE: <?php echo $date_ini; ?> FECHA HASTA: <?php echo $date_end; ?></th>

  </tr>
    

    <?php echo $mtto->RMTTOFailsGeneral($date_ini, $date_end); ?>
