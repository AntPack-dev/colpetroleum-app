...
if(isset($_POST['btngeneratereport']))
{
  ...
  $warehouse = $mysqli->real_escape_string($_POST['warehouse']);

  $warehouse_name = $mtto->getValueMtto('description_warehouse', 'warehouse', 'id_warehouse', $warehouse);
...
<page backtop="25mm" backbottom="15mm" backleft="0mm" backright="0mm">
  ...
  <table style="color: white; text-align:center; font-size: 20px; border: 0.5px solid #273746; border-radius: 5px; background-color: #B03A2E ;">
    <tr>
      <th style="width: 1080px;">LISTADO DE ACTIVOS - <?php echo $warehouse_name; ?></th>
    </tr>
  </table>
  ...
  <tr style="background-color: #273746; text-align:center; ">
    <th colspan="5" style="color: white; border-radius: 2px; border: 0.5px solid black; height: 20px;">FECHA DESDE: <?php echo $date_ini; ?> FECHA HASTA: <?php echo $date_end; ?></th>
    <th colspan="5" style="color: white; border-radius: 2px; border: 0.5px solid black; height: 20px;">INVENTARIO DE ALMACENES</th>
  </tr>
    
  <?php echo $mtto->RMTTOActivesWare($date_ini, $date_end, $warehouse); ?>
