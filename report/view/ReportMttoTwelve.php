...
<page backtop="25mm" backbottom="15mm" backleft="0mm" backright="0mm">
  ...
  <table style="color: white; text-align:center; font-size: 20px; border: 0.5px solid #273746; border-radius: 5px; background-color: #B03A2E ;">
    <tr>
      <th style="width: 750px;">REPORTE - FALLAS O AVERÍAS</th>
    </tr>
  </table>
  ...
  <tr style="background-color: #273746; text-align:center; ">
    <th colspan="8" style="color: white; border-radius: 2px; border: 0.5px solid black; height: 20px;"><?php echo $unity_name; ?> | FECHA DESDE: <?php echo $date_ini; ?> FECHA HASTA: <?php echo $date_end; ?></th>

  </tr>
    <?php echo $mtto->RMTTOFailsUnity($date_ini, $date_end, $unity); ?>
